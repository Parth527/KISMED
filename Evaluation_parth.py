...
def get_summary(x_test, y_true, model):
    ...
    print('Sensitivity: Normal = %.3f, AFib = %.3f' % (Se[0], Se[1]))
    print('Specificity: Normal = %.3f, AFib = %.3f' % (Sp[0], Sp[1]))
    print('Positive predictive value: Normal = %.3f, AFib = %.3f' % (PPV[0], PPV[1]))
    print('Negative predictive value: Normal = %.3f, AFib = %.3f' % (NPV[0], NPV[1]))
